            ...
            <div class="row">
                <div class="col-md-4 mb-5 p-0">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a class="text-secondary mb-2" href="/terminos"><i class="fa fa-angle-right mr-2"></i>Términos y condiciones</a>
                        <a class="text-secondary" href="/politicas"><i class="fa fa-angle-right mr-2"></i>Políticas de privacidad</a>
                    </div>
                </div>
                <div class="col-md-4 mb-5 p-0">
